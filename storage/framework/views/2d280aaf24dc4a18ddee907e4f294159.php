 ...
 <?php if($showSidebar): ?>
  ...
  <?php $__env->startSection('sidebar'); ?>
    ...
    <div class="">
      ...
      <div id="menu-blog-categories" class="mt-2 ml-2 hidden flex-col text-sm space-y-1">
        <a href="<?php echo e(route('admin.blog_categories.index')); ?>" class="block px-3 py-2 rounded-lg hover:bg-gray-50">All Categories</a>
        <a href="<?php echo e(route('admin.blog_categories.create')); ?>" class="block px-3 py-2 rounded-lg hover:bg-gray-50">Add New Category</a>
      </div>
    </div>
    ...
    <div class="">
      ...
      <div id="menu-blogs" class="mt-2 ml-2 hidden flex-col text-sm space-y-1">
        <a href="<?php echo e(route('admin.blogs.index')); ?>" class="block px-3 py-2 rounded-lg hover:bg-gray-50">All Blogs</a>
        <a href="<?php echo e(route('admin.blogs.create')); ?>" class="block px-3 py-2 rounded-lg hover:bg-gray-50">Add New Blog</a>
      </div>
    </div>
    ...
    <div class="">
      ...
      <div id="menu-jobs" class="mt-2 ml-2 hidden flex-col text-sm space-y-1">
        <a href="<?php echo e(route('admin.jobs.index')); ?>" class="block px-3 py-2 rounded-lg hover:bg-gray-50">All Jobs</a>
        <a href="<?php echo e(route('admin.jobs.create')); ?>" class="block px-3 py-2 rounded-lg hover:bg-gray-50">Add Job</a>
        <a href="<?php echo e(route('admin.job.job_applications')); ?>" class="block px-3 py-2 rounded-lg hover:bg-gray-50">Job Applications</a>
      </div>
    </div>
    ...
    <div class="">
      ...
      <div id="menu-staff" class="mt-2 ml-2 hidden flex-col text-sm space-y-1">
        <a href="<?php echo e(route('admin.staff.index')); ?>" class="block px-3 py-2 rounded-lg hover:bg-gray-50">All Staffs</a>
        <a href="<?php echo e(route('admin.staff.create')); ?>" class="block px-3 py-2 rounded-lg hover:bg-gray-50">Add Staff</a>
      </div>
    </div>
    ...
    <div class="">
      ...
      <div id="menu-clients" class="mt-2 ml-2 hidden flex-col text-sm space-y-1">
        <a href="<?php echo e(route('admin.clients.index')); ?>" class="block px-3 py-2 rounded-lg hover:bg-gray-50">All Clients</a>
        <a href="<?php echo e(route('admin.clients.create')); ?>" class="block px-3 py-2 rounded-lg hover:bg-gray-50">Add Clients</a>
      </div>
    </div>

    
    <div class="">
      <a href="<?php echo e(route('admin.contact_enquiries')); ?>" class="block w-full text-left flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-50">
        <!-- Icon: envelope -->
    ...
    <div class="">
      <a href="<?php echo e(route('admin.timesheets.index')); ?>" class="block w-full text-left flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-50">
        <!-- Icon: clock -->
    ...
    <div class="">
      ...
      <div id="menu-payslips" class="mt-2 ml-2 hidden flex-col text-sm space-y-1">
        <a href="<?php echo e(route('admin.payslips.index')); ?>" class="block px-3 py-2 rounded-lg hover:bg-gray-50">All Payslips</a>
        <a href="<?php echo e(route('admin.payslips.create')); ?>" class="block px-3 py-2 rounded-lg hover:bg-gray-50">Add Payslips</a>
      </div>
    </div>
    ...
    <div class="">
      ...
      <div id="menu-certifications" class="mt-2 ml-2 hidden flex-col text-sm space-y-1">
        <a href="<?php echo e(route('admin.certifications.index')); ?>" class="block px-3 py-2 rounded-lg hover:bg-gray-50">All Certifications</a>
        <a href="<?php echo e(route('admin.certifications.create')); ?>" class="block px-3 py-2 rounded-lg hover:bg-gray-50">Add Certification</a>
      </div>
    </div>
  ...
  <?php echo $__env->yieldSection(); ?>
    ...
    <?php endif; ?>
      ...
      </script><?php /**PATH C:\Users\digitizal\Downloads\staff_portal\resources\views/layouts/admin_navigation.blade.php ENDPATH**/ ?>