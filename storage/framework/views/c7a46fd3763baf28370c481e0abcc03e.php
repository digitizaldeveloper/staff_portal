...
<?php $__env->startSection('page-heading', 'Clients'); ?>
    ...
    <table class="w-full text-left">
        <thead class="bg-gray-50 border-b border-gray-200">
            <tr>
                ...
                <th class="px-6 py-4 font-semibold text-gray-700 text-sm">Phone</th>
        ...
        <tbody class="divide-y divide-gray-200">
            <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="hover:bg-gray-50 transition">
                    <td class="px-6 py-4 text-sm text-gray-900 font-medium"><?php echo e($client->name); ?></td>
                    <td class="px-6 py-4 text-sm text-gray-600"><?php echo e($client->email); ?></td>
                    <td class="px-6 py-4 text-sm text-gray-600"><?php echo e($client->phone); ?></td>
                    <td class="px-6 py-4 text-sm">
                        ...
                        <?php else: ?>
                            <span class="px-2.5 py-1 rounded-full text-xs font-semibold bg-red-100 text-red-800">Inactive</span>
                        <?php endif; ?>
                    </td>
                    <td class="px-6 py-4 text-sm flex gap-2">
                        <a href="<?php echo e(route('admin.clients.edit', $client->id)); ?>"
                        ...
                        <button onclick="openModal(<?php echo e($client->id); ?>)"
...
<div id="deleteModal" class="hidden fixed inset-0 bg-black/50 flex items-center justify-center z-50">
    <div class="bg-white p-6 rounded-lg w-80 text-center shadow-lg">
        <h2 class="text-xl font-semibold mb-2 text-gray-900">Delete Client?</h2>
        <p class="text-sm text-gray-600 mb-6">Are you sure you want to delete this client?</p>
...
function openModal(id) {
    ...
    document.getElementById('deleteForm').action = '/admin/clients/delete/' + id;
}
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\digitizal\Downloads\staff_portal\resources\views/admin/clients/index.blade.php ENDPATH**/ ?>