...
<script>
  ...
  // Export CSV (dummy)
   document.getElementById('btnExportTS')?.addEventListener('click', () => {
    const rows = <?php echo json_encode($rowsData, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u461551961/domains/wponline.io/public_html/staff_portal/resources/views/admin/timesheets.blade.php ENDPATH**/ ?>