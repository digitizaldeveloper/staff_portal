...
?>
 <?php if($showSidebar): ?>
  ...
  <?php $__env->startSection('sidebar'); ?>
    ...
    <div class="px-3 pt-2 text-[11px] uppercase tracking-wider text-gray-500">Staff Navigation</div>
    ...
    <div class="">
      ...
      <div id="menu-jobs" class="mt-2 ml-2 hidden flex-col text-sm space-y-1">
        <a href="<?php echo e(route('all_jobs')); ?>" class="block px-3 py-2 rounded-lg hover:bg-gray-50">All Jobs</a>
      </div>
    </div>

    
    <div class="">
      <button type="button" class="w-full text-left flex items-center justify-between px-3 py-2 rounded-lg hover:bg-gray-50" data-toggle="menu-timesheets">
        <span class="flex items-center gap-3">
          <!-- Icon: users -->
          <i class="fas fa-clock fa-fw text-lg text-gray-800" aria-hidden="true"></i>
          <span class="text-base text-gray-800">My Timesheets</span>
        </span>
        <svg class="w-4 h-4 text-gray-400 transform transition-transform" data-chevron-for="menu-timesheets" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
          <path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 10.94l3.71-3.71a.75.75 0 111.06 1.06l-4.24 4.24a.75.75 0 01-1.06 0L5.21 8.29a.75.75 0 01.02-1.08z" clip-rule="evenodd" />
        </svg>
      </button>
      <div id="menu-timesheets" class="mt-2 ml-2 hidden flex-col text-sm space-y-1">
        <a href="<?php echo e(route('staff.timesheets.index')); ?>" class="block px-3 py-2 rounded-lg hover:bg-gray-50">Timesheets</a>
        <a href="<?php echo e(route('staff.timesheets.create')); ?>" class="block px-3 py-2 rounded-lg hover:bg-gray-50">Add Timesheets</a>
      </div>
    </div>
    ...
    <div class="">
      <a href="<?php echo e(route('staff.payslips-personal')); ?>" class="block w-full text-left flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-50">
        <!-- Icon: file-invoice -->
        <i class="fas fa-file-invoice fa-fw text-lg text-gray-800" aria-hidden="true"></i>
        <span class="text-base text-gray-800">My Payslips</span>
      </a>
    </div>

    
    <div class="">
      <a href="<?php echo e(route('staff.certifications.index')); ?>" class="block w-full text-left flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-50">
        <!-- Icon: certificate -->
        <i class="fas fa-certificate fa-fw text-lg text-gray-800" aria-hidden="true"></i>
        <span class="text-base text-gray-800">My Certifications</span>
      </a>
    </div>

    
    <div class="">
      <a href="<?php echo e(route('contact.store')); ?>" class="block w-full text-left flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-50">
        <!-- Icon: envelope -->
        <i class="fas fa-envelope fa-fw text-lg text-gray-800" aria-hidden="true"></i>
        <span class="text-base text-gray-800">Contact Us</span>
      </a>
    </div>
  ...
  <?php echo $__env->yieldSection(); ?>
    ...
    <?php endif; ?>
      ...
      <script>
        // Simple sidebar dropdown toggle for staff navigation
        (function () {
      ...
      </script><?php /**PATH C:\Users\digitizal\Downloads\staff_portal\resources\views/layouts/staff_navigation.blade.php ENDPATH**/ ?>