...
<div class="space-y-6">
    ...
    <div class="rounded-3xl border border-gray-200 bg-gradient-to-r from-indigo-600 to-purple-500 px-8 py-10 text-white shadow-sm">
        <div class="flex flex-wrap items-center justify-between gap-6">
            ...
            <div class="rounded-2xl border border-white/30 bg-white/10 px-6 py-4 text-center">
                <p class="text-4xl font-bold"><?php echo e($stats['pending']); ?></p>
    ...
    <div class="grid gap-4 md:grid-cols-3">
        <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <p class="mt-3 text-3xl font-semibold text-gray-900"><?php echo e($stats['staff']); ?></p>
            <p class="text-xs text-emerald-600 mt-1">All active and onboarded members</p>
        </div>
        <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            <p class="text-sm text-gray-500">Clients</p>
            <p class="mt-3 text-3xl font-semibold text-gray-900"><?php echo e($stats['clients']); ?></p>
            <p class="text-xs text-indigo-600 mt-1">Including active contracts</p>
        </div>
        <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            <p class="text-sm text-gray-500">Open jobs</p>
            <p class="mt-3 text-3xl font-semibold text-gray-900"><?php echo e($stats['jobs']); ?></p>
    ...
    <div class="grid gap-6 lg:grid-cols-3">
        <div class="lg:col-span-2 rounded-2xl border border-gray-200 bg-white shadow-sm">
            <div class="flex items-center justify-between border-b border-gray-100 px-6 py-4">
                ...
                <a href="<?php echo e(route('staff.timesheets.index')); ?>" class="text-sm font-semibold text-indigo-600 hover:text-indigo-700">
                    Manage →
                </a>
            </div>
            <div class="overflow-x-auto">
                <table class="min-w-full text-sm text-gray-700">
                    ...
                    <tbody class="divide-y divide-gray-100 bg-white">
                        <?php $__empty_1 = true; $__currentLoopData = $pendingTimesheets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td class="px-6 py-4">
                                    <div class="font-semibold text-gray-900"><?php echo e(data_get($ts, 'staff.name', 'Staff member')); ?></div>
                                    <div class="text-xs text-gray-400">#<?php echo e(str_pad($ts['id'] ?? 0, 4, '0', STR_PAD_LEFT)); ?></div>
                                </td>
                                <td class="px-6 py-4"><?php echo e(Carbon::parse($ts['date'] ?? now())->format('d M Y')); ?></td>
                                <td class="px-6 py-4">
                                    <?php echo e(data_get($ts, 'client.name', 'Client #' . ($ts['client_id'] ?? ''))); ?>

                                </td>
                                <td class="px-6 py-4 font-semibold text-gray-900"><?php echo e(number_format(data_get($ts, 'total_hours', 0), 2)); ?> hrs</td>
                            </tr>
        ...
        <div class="rounded-2xl border border-gray-200 bg-white shadow-sm">
            ...
            <ul class="divide-y divide-gray-100">
                <?php $__empty_1 = true; $__currentLoopData = $recentStaff; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <li class="px-6 py-4">
                        <p class="font-semibold text-gray-900"><?php echo e($member['name'] ?? 'Name withheld'); ?></p>
                        <p class="text-sm text-gray-500"><?php echo e($member['role'] ?? 'Staff'); ?></p>
                        <p class="text-xs text-gray-400 mt-1">
                            Joined <?php echo e(Carbon::parse($member['created_at'] ?? now())->diffForHumans()); ?>
    ...
    <div class="grid gap-6 lg:grid-cols-2">
        <div class="rounded-2xl border border-gray-200 bg-white shadow-sm">
            <div class="flex items-center justify-between border-b border-gray-100 px-6 py-4">
                ...
                <a href="<?php echo e(route('admin.jobs.index') ?? '#'); ?>" class="text-sm font-semibold text-emerald-600 hover:text-emerald-700">
                    Manage →
                </a>
            </div>
            <ul class="divide-y divide-gray-100">
                <?php $__empty_1 = true; $__currentLoopData = $recentJobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <li class="px-6 py-4">
                        <div class="font-semibold text-gray-900"><?php echo e($job['title'] ?? 'Untitled role'); ?></div>
                        <p class="text-sm text-gray-500">
                            <?php echo e($job['location'] ?? 'Location TBD'); ?> • <?php echo e($job['type'] ?? 'Contract'); ?>

                        </p>
                        <p class="text-xs text-gray-400 mt-1">
                            Posted <?php echo e(Carbon::parse($job['created_at'] ?? now())->diffForHumans()); ?>
        ...
        <div class="rounded-2xl border border-gray-200 bg-white shadow-sm">
            ...
            <div class="grid gap-4 px-6 py-6 md:grid-cols-2">
                ...
                <a href="<?php echo e(route('admin.contact_enquiries')); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\digitizal\Downloads\staff_portal\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>