...
<?php $__env->startSection('page-heading', 'Add Client'); ?>
...
<div class="bg-white shadow-sm rounded-lg border border-gray-200 overflow-hidden mx-auto">
    ...
    <div class="px-6 py-6">
        ...
        <form action="<?php echo e(route('admin.clients.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\digitizal\Downloads\staff_portal\resources\views/admin/clients/create.blade.php ENDPATH**/ ?>