...
<?php $__env->startSection('page-heading', 'Payslips Management'); ?>
...
<div class="bg-white shadow-sm rounded-lg border border-gray-200 overflow-hidden">
    ...
    <div class="px-6 py-6 border-b border-gray-200 flex justify-between items-center">
        ...
        <a href="<?php echo e(route('admin.payslips.create')); ?>"
    ...
    <table class="w-full text-left">
        ...
        <tbody class="divide-y divide-gray-200">
            ...
            <tr class="hover:bg-gray-50 transition">
                <td class="px-6 py-4 text-sm text-gray-900 font-medium"><?php echo e($payslip->staff->name); ?></td>
                <td class="px-6 py-4 text-sm text-gray-600"><?php echo e($payslip->pay_period); ?></td>
                <td class="px-6 py-4 text-sm">
                    <a href="<?php echo e(asset('payslips/'.$payslip->file_path)); ?>" target="_blank"
                       class="text-blue-600 hover:underline">
                       View PDF
                    </a>
                </td>
                <td class="px-6 py-4 text-sm text-gray-600"><?php echo e($payslip->created_at->format('d M, Y')); ?></td>
                <td class="px-6 py-4 text-sm flex gap-2">
                    <a href="<?php echo e(route('admin.payslips.edit', $payslip->id)); ?>"
                    ...
                    <button onclick="openDeleteModal(<?php echo e($payslip->id); ?>)"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\digitizal\Downloads\staff_portal\resources\views/admin/payslips/index.blade.php ENDPATH**/ ?>