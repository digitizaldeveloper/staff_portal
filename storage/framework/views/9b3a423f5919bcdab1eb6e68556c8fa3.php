...
<?php $__env->startSection('page-heading', 'Edit Timesheet'); ?>
...
<div class="rounded-2xl border border-gray-200 bg-white shadow-sm overflow-hidden">
    ...
    <form method="POST" action="<?php echo e(route('staff.timesheets.update', $timesheet->id)); ?>" class="space-y-5 px-6 py-6">
        <?php echo csrf_field(); ?>
        ...
        <div class="space-y-1">
            ...
            <input type="date" name="date" id="date"
                   value="<?php echo e(old('date', $timesheet->date)); ?>"
            ...
            <select name="client_id" id="client_id"
                ...
                <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($client->id); ?>"
                        <?php if(old('client_id', $timesheet->client_id) == $client->id): echo 'selected'; endif; ?>>
        ...
        <div class="grid gap-4 md:grid-cols-2">
            <div class="space-y-1">
                ...
                <input type="time" name="start_time" id="start_time"
                       value="<?php echo e(old('start_time', $timesheet->start_time)); ?>"
                       class="w-full rounded-2xl border border-gray-200 px-4 py-2.5 text-gray-900 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                       required>
            </div>
            <div class="space-y-1">
                ...
                <input type="time" name="end_time" id="end_time"
                       value="<?php echo e(old('end_time', $timesheet->end_time)); ?>"
                       class="w-full rounded-2xl border border-gray-200 px-4 py-2.5 text-gray-900 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                       required>
            </div>
        </div>
        ...
        <div class="space-y-1">
            ...
            <input type="number" name="break_minutes" id="break_minutes"
                   value="<?php echo e(old('break_minutes', $timesheet->break_minutes)); ?>"
                   class="w-full rounded-2xl border border-gray-200 px-4 py-2.5 text-gray-900 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                   placeholder="e.g. 30">
        </div>
        ...
        <div class="space-y-1">
            ...
            <input type="text" id="total_hours"
                   value="<?php echo e($timesheet->total_hours); ?>"
        ...
        <div class="space-y-1">
            ...
            <textarea name="notes" id="notes" rows="4"
                      class="w-full rounded-2xl border border-gray-200 px-4 py-2.5 text-gray-900 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                      placeholder="Optional context for reviewer"><?php echo e(old('notes', $timesheet->notes)); ?></textarea>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\digitizal\Downloads\staff_portal\resources\views/staff/timesheets/edit.blade.php ENDPATH**/ ?>