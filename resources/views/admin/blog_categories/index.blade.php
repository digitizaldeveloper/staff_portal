...
<div class="bg-white shadow-sm rounded-lg border border-gray-200 overflow-hidden">
    ...
    <div class="px-6 py-6 border-b border-gray-200 flex justify-between items-center">
        ...
        <a href="{{ route('admin.blog_categories.create') }}"
        ...
        <tbody class="divide-y divide-gray-200">
            @forelse ($categories as $category)
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="px-6 py-4 text-sm text-gray-900 font-medium">{{ $category->title }}</td>
                    ...
                    <td class="px-6 py-4 text-sm flex gap-2">
                        ...
                        <button onclick="openDeleteModal('{{ route('admin.blog_categories.destroy', $category->id) }}')"
