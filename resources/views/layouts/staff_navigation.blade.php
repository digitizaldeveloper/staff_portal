  ...
  @section('sidebar')
    ...
    <div class="">
      ...
      <div id="menu-jobs" class="mt-2 ml-2 hidden flex-col text-sm space-y-1">
        <a href="{{ route('all_jobs') }}" class="block px-3 py-2 rounded-lg hover:bg-gray-50">All Jobs</a>
      </div>
    </div>
    ...
    <div class="">
      ...
      <div id="menu-timesheets" class="mt-2 ml-2 hidden flex-col text-sm space-y-1">
        <a href="{{ route('staff.timesheets.index') }}" class="block px-3 py-2 rounded-lg hover:bg-gray-50">Timesheets</a>
        <a href="{{ route('staff.timesheets.create') }}" class="block px-3 py-2 rounded-lg hover:bg-gray-50">Add Timesheets</a>
      </div>
    </div>
    ...
    {{-- My Payslips --}}
    <div class="">
      <a href="{{ route('staff.payslips-personal') }}" class="block w-full text-left flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-50">
        <!-- Icon: file-invoice -->
    ...
    {{-- My Certifications --}}
    <div class="">
      <a href="{{ route('staff.certifications.index') }}" class="block w-full text-left flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-50">
        <!-- Icon: certificate -->
    ...
    {{-- Contact Us --}}
    <div class="">
      <a href="{{ route('contact.store') }}" class="block w-full text-left flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-50">
        <!-- Icon: envelope -->
