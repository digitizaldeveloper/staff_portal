...
@endphp
  ...
  @section('sidebar')
    ...
    <a href="{{ route('staff.profile-timesheets') }}"
       class="block px-3 py-2 rounded-lg {{ request()->routeIs('staff.profile-timesheets') ? 'bg-gray-100 font-medium' : 'hover:bg-gray-50' }}">
      🙍 Profile & Timesheets
    </a>

    <a href="{{ route('staff.timesheets-payslips') }}"
       class="block px-3 py-2 rounded-lg {{ request()->routeIs('staff.timesheets-payslips') ? 'bg-gray-100 font-medium' : 'hover:bg-gray-50' }}">
      🕒 Timesheets & Payslips
    </a>

    <a href="{{ route('staff.payslips-personal') }}"
       class="block px-3 py-2 rounded-lg {{ request()->routeIs('staff.payslips-personal') ? 'bg-gray-100 font-medium' : 'hover:bg-gray-50' }}">
      🧾 My Payslips
    </a>

    <a href="{{ route('staff.certifications') }}"
       class="block px-3 py-2 rounded-lg {{ request()->routeIs('staff.certifications') ? 'bg-gray-100 font-medium' : 'hover:bg-gray-50' }}">
    ...
    <a href="{{ route('admin.staff-management') }}"
       class="block px-3 py-2 rounded-lg {{ request()->routeIs('admin.staff-management') ? 'bg-gray-100 font-medium' : 'hover:bg-gray-50' }}">
      👥 Staff Management
    </a>

    <a href="{{ route('admin.timesheets') }}"
       class="block px-3 py-2 rounded-lg {{ request()->routeIs('admin.timesheets') ? 'bg-gray-100 font-medium' : 'hover:bg-gray-50' }}">
      📋 Timesheets Review
    </a>

    <a href="{{ route('admin.payroll') }}"
       class="block px-3 py-2 rounded-lg {{ request()->routeIs('admin.payroll') ? 'bg-gray-100 font-medium' : 'hover:bg-gray-50' }}">
      💸 Payroll / Payslips
    </a>

    <a href="{{ route('admin.jobs-applications') }}"
       class="block px-3 py-2 rounded-lg {{ request()->routeIs('admin.jobs-applications') ? 'bg-gray-100 font-medium' : 'hover:bg-gray-50' }}">
      📄 Jobs & Applications
    </a>
  ...
  @show
    ...
    <main class="flex-1 min-w-0">
      ...
      <footer class="p-4 text-center text-xs text-gray-500">
        @yield('footer','© ' . now()->year . ' Admin. All rights reserved.')
      </footer>
    </main>
  </div>
