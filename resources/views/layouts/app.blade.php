...
@endphp
  ...
  <div class="min-h-screen flex">
    ...
    @if(auth()->check() && str_contains($userRole, 'admin'))
      @include('layouts.admin_navigation')
    @elseif(auth()->check() && str_contains($userRole, 'staff'))
      @include('layouts.staff_navigation')
    @else
      {{-- Fallback for guests or unknown roles: show staff navigation --}}
      @include('layouts.staff_navigation')
    @endif
              ...
              <div class="relative">
                ...
                <div id="userDropdown" class="hidden absolute right-0 mt-2 w-56 rounded-md shadow-soft bg-white ring-1 ring-black ring-opacity-5 z-50">
                  <div class="py-3 px-4 border-b">
                    ...
                    <p class="text-sm text-gray-500">{{ Auth::user()->role ?? 'Staff' }}</p>
                  </div>
                  <div class="py-1">
